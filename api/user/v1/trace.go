...
type TraceListReq struct {
	response.PageResult
	g.Meta       `path:"/trace/list" method:"get" tags:"Trace" summary:"Trace List"`
...
type TraceViewReq struct {
	g.Meta      `path:"/trace/view" method:"get" tags:"Trace" summary:"Trace View"`
	RoleId      uint64 `json:"roleId"       description:"角色ID"`
	RedTrace    int    `json:"redTrace" description:"红轨"`
	YellowTrace int    `json:"yellowTrace" description:"黄轨"`
	BlueTrace   int    `json:"blueTrace" description:"蓝轨"`
...
type TraceUpdateReq struct {
	g.Meta       `path:"/trace/update" method:"put" tags:"Trace" summary:"Trace Update"`
...
type TraceReduceReq struct {
	g.Meta      `path:"/trace/Reduce" method:"delete" tags:"Trace" summary:"Trace Delete"`
	RoleId      uint64 `json:"roleId"       description:"角色ID"`
	RedTrace    int    `json:"redTrace" description:"红轨"`
	YellowTrace int    `json:"yellowTrace" description:"黄轨"`
	BlueTrace   int    `json:"blueTrace" description:"蓝轨"`
